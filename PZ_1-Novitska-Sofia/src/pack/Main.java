...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Время вставки в начало" + "ArrayList =" + (stop1 - start1)/1e9 + "s");
        ...
        System.out.println("Время вставки в начало" + "LinkedList =" + (stop2 - start2)/1e9 + "s");
        ...
        System.out.println("Время чтения каждого элемента" + "ArrayList =" + (stop3 - start3)/1e9 + "s");
        ...
        System.out.println("Время чтения каждого эл-та" + "LinkedList =" + (stop4 - start4)/1e9 + "s");
